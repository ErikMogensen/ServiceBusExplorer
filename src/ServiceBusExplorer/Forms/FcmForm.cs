...
{
    public partial class FcmForm : Form
    {
        #region Private Constants
        //***************************
        // Constants
        //***************************
        private const string DefaultLabel = "Fire ";
        #endregion

        #region Public Constructor
        public FcmForm(string label, string content)
        {
            InitializeComponent();
        ...
        public FcmForm(string text, string label, string content)
        {
            InitializeComponent();
        ...
        public FcmForm(string text, string label, string content, bool hideOpen = false)
        {
            InitializeComponent();
            if (!string.IsNullOrWhiteSpace(text))
            {
        ...
        private void FcmForm_Activated(object sender, EventArgs e)
        {
            txtContent.Focus();
